   ...
   render() {
     return (
       <li className="list-group-item">
          ...
          <button className="btn btn-secondary" value = { this.props.key } onClick={this.showEmp.bind(this)}> show employees</button>
          <button className="btn btn-info" value = { this.props.item } onClick={this.addRepo.bind(this)}> add Repo </button>
          <button className="btn btn-secondary" value = { this.props.key } onClick={this.showRepo.bind(this)}> Show Repo</button>
